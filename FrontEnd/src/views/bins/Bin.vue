    ...
    <div class="locator-view">
        <div class="form-container">
            <div class="form-header">
                <h1>Search the bin you want to modify!</h1>
                <br>
                <p class="desc">As an admin you have the power to either <strong class="impt">add </strong> or <strong class="impt">edit</strong> bins.
                <br>Search for the location of the bin you want to make a change to by using either the postal code or full address. Once the bin location is returned, you can modify the bin according to your wish.
                </p>
            ...
            <div class="form-locate">
                <Form @submit="onSubmit" :validation-schema="schema" v-on:submit.prevent="submitForm">
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary saved-locations-btn">View Recently Modified Locations</button>
